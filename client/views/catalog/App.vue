    ...
    <header class="hidden-md-up- hidden-sm-down-">
      <div class="d-flex flex-wrap h-100 ml-auto" style="width: 300px;">
        <nav class="align-items-center d-flex justify-content-end ml-auto">
          <div class="nav-item">
            <a v-bind:class="{'active':active == 'index'}"><router-link to="/">路線</router-link></a>
          </div>
          <div class="nav-item">
            <a v-bind:class="{'active':active == 'hotel'}"><router-link to="/hotel">住宿</router-link></a>
          </div>
          <div class="nav-item">
            <a v-bind:class="{'active':active == 'food'}"><router-link to="/food/a">美食</router-link></a>
          </div>
        </nav>
      </div>
    </header>
